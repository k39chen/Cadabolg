...
void BuildResourceTable()
{
	////////////
    // IMAGES
	AssetMgr->Create<Texture>   ("../assets/img/battle/adversary.png");
	AssetMgr->Create<Texture>   ("../assets/img/battle/comrade.png");
	AssetMgr->Create<Texture>   ("../assets/img/battle/dragon.png");
	AssetMgr->Create<Texture>   ("../assets/img/battle/effect.png");
	AssetMgr->Create<Texture>   ("../assets/img/battle/grass.png");
	AssetMgr->Create<Texture>   ("../assets/img/battle/health_bar_green.png");
	AssetMgr->Create<Texture>   ("../assets/img/battle/health_bar_red.png");
	
	AssetMgr->Create<Texture>   ("../assets/img/hud/hud_b_frame.png");
	AssetMgr->Create<Texture>   ("../assets/img/hud/hud_b_health.png");
	AssetMgr->Create<Texture>   ("../assets/img/hud/hud_b_mana.png");
	AssetMgr->Create<Texture>   ("../assets/img/hud/hud_b_mask.png");
	AssetMgr->Create<Texture>   ("../assets/img/hud/hud_b_mug_back.png");

	AssetMgr->Create<Texture>   ("../assets/img/metasync/metasync_empty.png");
	AssetMgr->Create<Texture>   ("../assets/img/metasync/metasync_full.png");
	
	AssetMgr->Create<Texture>   ("../assets/img/cursor.png");
	AssetMgr->Create<Texture>   ("../assets/img/cursoreffect.png");
	AssetMgr->Create<Texture>   ("../assets/img/logo.png");
	AssetMgr->Create<Texture>   ("../assets/img/msn.png");
	AssetMgr->Create<Texture>   ("../assets/img/wskin_default.png");
	
    ////////////
    // FONTS
    AssetMgr->Create<Font>      ("../assets/font/ninjapenguin.ttf");
	AssetMgr->Create<Font>      ("../assets/font/droid.ttf");
